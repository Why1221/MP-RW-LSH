...
#include <popcnt.hpp>// helper for popcount in various compilers
...
struct FeigenbaumSketchL1 {
 ...
 private:
  ...
  void _generate_random_vectors() {
    ...
    std::bitset<WORD_SIZE> bits;
    _random_vectors.resize(_m * _d * _inner_dim);
    ...
    for (unsigned si = 0; si < _m; ++si) {
      for (unsigned sij = 0; sij < _d; ++sij) {
        unsigned j = 0;
        unsigned idx = si * _d * _inner_dim + sij * _inner_dim;
        for (unsigned sijk = 0; sijk < _max_range; ++sijk) {
          bits[j] = rng();
          ++j;
          if (j % WORD_SIZE == 0) {
  ...
  unsigned _inner_dim;
  unsigned _seed;
  std::vector<my_word_t> _random_vectors;// random vectors
  static constexpr unsigned MAX_RANGE_FSL1 = (1u<<31u) -1u;
...
inline int16_t inner_product(uint64_t va, uint64_t vb) {
  _tmp_a[0] = ((va & 0x1ull) == 0 ? (-1) : 1);
  _tmp_b[0] = ((vb & 0x1ull) == 0 ? (-1) : 1);

  _tmp_a[1] = ((va & 0x2ull) == 0 ? (-1) : 1);
  _tmp_b[1] = ((vb & 0x2ull) == 0 ? (-1) : 1);

  _tmp_a[2] = ((va & 0x4ull) == 0 ? (-1) : 1);
  _tmp_b[2] = ((vb & 0x4ull) == 0 ? (-1) : 1);

  _tmp_a[3] = ((va & 0x8ull) == 0 ? (-1) : 1);
  _tmp_b[3] = ((vb & 0x8ull) == 0 ? (-1) : 1);

  _tmp_a[4] = ((va & 0x10ull) == 0 ? (-1) : 1);
  _tmp_b[4] = ((vb & 0x10ull) == 0 ? (-1) : 1);

  _tmp_a[5] = ((va & 0x20ull) == 0 ? (-1) : 1);
  _tmp_b[5] = ((vb & 0x20ull) == 0 ? (-1) : 1);

  _tmp_a[6] = ((va & 0x40ull) == 0 ? (-1) : 1);
  _tmp_b[6] = ((vb & 0x40ull) == 0 ? (-1) : 1);

  _tmp_a[7] = ((va & 0x80ull) == 0 ? (-1) : 1);
  _tmp_b[7] = ((vb & 0x80ull) == 0 ? (-1) : 1);

  _tmp_a[8] = ((va & 0x100ull) == 0 ? (-1) : 1);
  _tmp_b[8] = ((vb & 0x100ull) == 0 ? (-1) : 1);

  _tmp_a[9] = ((va & 0x200ull) == 0 ? (-1) : 1);
  _tmp_b[9] = ((vb & 0x200ull) == 0 ? (-1) : 1);

  _tmp_a[10] = ((va & 0x400ull) == 0 ? (-1) : 1);
  _tmp_b[10] = ((vb & 0x400ull) == 0 ? (-1) : 1);

  _tmp_a[11] = ((va & 0x800ull) == 0 ? (-1) : 1);
  _tmp_b[11] = ((vb & 0x800ull) == 0 ? (-1) : 1);

  _tmp_a[12] = ((va & 0x1000ull) == 0 ? (-1) : 1);
  _tmp_b[12] = ((vb & 0x1000ull) == 0 ? (-1) : 1);

  _tmp_a[13] = ((va & 0x2000ull) == 0 ? (-1) : 1);
  _tmp_b[13] = ((vb & 0x2000ull) == 0 ? (-1) : 1);

  _tmp_a[14] = ((va & 0x4000ull) == 0 ? (-1) : 1);
  _tmp_b[14] = ((vb & 0x4000ull) == 0 ? (-1) : 1);

  _tmp_a[15] = ((va & 0x8000ull) == 0 ? (-1) : 1);
  _tmp_b[15] = ((vb & 0x8000ull) == 0 ? (-1) : 1);

  _tmp_a[16] = ((va & 0x10000ull) == 0 ? (-1) : 1);
  _tmp_b[16] = ((vb & 0x10000ull) == 0 ? (-1) : 1);

  _tmp_a[17] = ((va & 0x20000ull) == 0 ? (-1) : 1);
  _tmp_b[17] = ((vb & 0x20000ull) == 0 ? (-1) : 1);

  _tmp_a[18] = ((va & 0x40000ull) == 0 ? (-1) : 1);
  _tmp_b[18] = ((vb & 0x40000ull) == 0 ? (-1) : 1);

  _tmp_a[19] = ((va & 0x80000ull) == 0 ? (-1) : 1);
  _tmp_b[19] = ((vb & 0x80000ull) == 0 ? (-1) : 1);

  _tmp_a[20] = ((va & 0x100000ull) == 0 ? (-1) : 1);
  _tmp_b[20] = ((vb & 0x100000ull) == 0 ? (-1) : 1);

  _tmp_a[21] = ((va & 0x200000ull) == 0 ? (-1) : 1);
  _tmp_b[21] = ((vb & 0x200000ull) == 0 ? (-1) : 1);

  _tmp_a[22] = ((va & 0x400000ull) == 0 ? (-1) : 1);
  _tmp_b[22] = ((vb & 0x400000ull) == 0 ? (-1) : 1);

  _tmp_a[23] = ((va & 0x800000ull) == 0 ? (-1) : 1);
  _tmp_b[23] = ((vb & 0x800000ull) == 0 ? (-1) : 1);

  _tmp_a[24] = ((va & 0x1000000ull) == 0 ? (-1) : 1);
  _tmp_b[24] = ((vb & 0x1000000ull) == 0 ? (-1) : 1);

  _tmp_a[25] = ((va & 0x2000000ull) == 0 ? (-1) : 1);
  _tmp_b[25] = ((vb & 0x2000000ull) == 0 ? (-1) : 1);

  _tmp_a[26] = ((va & 0x4000000ull) == 0 ? (-1) : 1);
  _tmp_b[26] = ((vb & 0x4000000ull) == 0 ? (-1) : 1);

  _tmp_a[27] = ((va & 0x8000000ull) == 0 ? (-1) : 1);
  _tmp_b[27] = ((vb & 0x8000000ull) == 0 ? (-1) : 1);

  _tmp_a[28] = ((va & 0x10000000ull) == 0 ? (-1) : 1);
  _tmp_b[28] = ((vb & 0x10000000ull) == 0 ? (-1) : 1);

  _tmp_a[29] = ((va & 0x20000000ull) == 0 ? (-1) : 1);
  _tmp_b[29] = ((vb & 0x20000000ull) == 0 ? (-1) : 1);

  _tmp_a[30] = ((va & 0x40000000ull) == 0 ? (-1) : 1);
  _tmp_b[30] = ((vb & 0x40000000ull) == 0 ? (-1) : 1);

  _tmp_a[31] = ((va & 0x80000000ull) == 0 ? (-1) : 1);
  _tmp_b[31] = ((vb & 0x80000000ull) == 0 ? (-1) : 1);

  _tmp_a[32] = ((va & 0x100000000ull) == 0 ? (-1) : 1);
  _tmp_b[32] = ((vb & 0x100000000ull) == 0 ? (-1) : 1);

  _tmp_a[33] = ((va & 0x200000000ull) == 0 ? (-1) : 1);
  _tmp_b[33] = ((vb & 0x200000000ull) == 0 ? (-1) : 1);

  _tmp_a[34] = ((va & 0x400000000ull) == 0 ? (-1) : 1);
  _tmp_b[34] = ((vb & 0x400000000ull) == 0 ? (-1) : 1);

  _tmp_a[35] = ((va & 0x800000000ull) == 0 ? (-1) : 1);
  _tmp_b[35] = ((vb & 0x800000000ull) == 0 ? (-1) : 1);

  _tmp_a[36] = ((va & 0x1000000000ull) == 0 ? (-1) : 1);
  _tmp_b[36] = ((vb & 0x1000000000ull) == 0 ? (-1) : 1);

  _tmp_a[37] = ((va & 0x2000000000ull) == 0 ? (-1) : 1);
  _tmp_b[37] = ((vb & 0x2000000000ull) == 0 ? (-1) : 1);

  _tmp_a[38] = ((va & 0x4000000000ull) == 0 ? (-1) : 1);
  _tmp_b[38] = ((vb & 0x4000000000ull) == 0 ? (-1) : 1);

  _tmp_a[39] = ((va & 0x8000000000ull) == 0 ? (-1) : 1);
  _tmp_b[39] = ((vb & 0x8000000000ull) == 0 ? (-1) : 1);

  _tmp_a[40] = ((va & 0x10000000000ull) == 0 ? (-1) : 1);
  _tmp_b[40] = ((vb & 0x10000000000ull) == 0 ? (-1) : 1);

  _tmp_a[41] = ((va & 0x20000000000ull) == 0 ? (-1) : 1);
  _tmp_b[41] = ((vb & 0x20000000000ull) == 0 ? (-1) : 1);

  _tmp_a[42] = ((va & 0x40000000000ull) == 0 ? (-1) : 1);
  _tmp_b[42] = ((vb & 0x40000000000ull) == 0 ? (-1) : 1);

  _tmp_a[43] = ((va & 0x80000000000ull) == 0 ? (-1) : 1);
  _tmp_b[43] = ((vb & 0x80000000000ull) == 0 ? (-1) : 1);

  _tmp_a[44] = ((va & 0x100000000000ull) == 0 ? (-1) : 1);
  _tmp_b[44] = ((vb & 0x100000000000ull) == 0 ? (-1) : 1);

  _tmp_a[45] = ((va & 0x200000000000ull) == 0 ? (-1) : 1);
  _tmp_b[45] = ((vb & 0x200000000000ull) == 0 ? (-1) : 1);

  _tmp_a[46] = ((va & 0x400000000000ull) == 0 ? (-1) : 1);
  _tmp_b[46] = ((vb & 0x400000000000ull) == 0 ? (-1) : 1);

  _tmp_a[47] = ((va & 0x800000000000ull) == 0 ? (-1) : 1);
  _tmp_b[47] = ((vb & 0x800000000000ull) == 0 ? (-1) : 1);

  _tmp_a[48] = ((va & 0x1000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[48] = ((vb & 0x1000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[49] = ((va & 0x2000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[49] = ((vb & 0x2000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[50] = ((va & 0x4000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[50] = ((vb & 0x4000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[51] = ((va & 0x8000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[51] = ((vb & 0x8000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[52] = ((va & 0x10000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[52] = ((vb & 0x10000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[53] = ((va & 0x20000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[53] = ((vb & 0x20000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[54] = ((va & 0x40000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[54] = ((vb & 0x40000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[55] = ((va & 0x80000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[55] = ((vb & 0x80000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[56] = ((va & 0x100000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[56] = ((vb & 0x100000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[57] = ((va & 0x200000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[57] = ((vb & 0x200000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[58] = ((va & 0x400000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[58] = ((vb & 0x400000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[59] = ((va & 0x800000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[59] = ((vb & 0x800000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[60] = ((va & 0x1000000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[60] = ((vb & 0x1000000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[61] = ((va & 0x2000000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[61] = ((vb & 0x2000000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[62] = ((va & 0x4000000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[62] = ((vb & 0x4000000000000000ull) == 0 ? (-1) : 1);

  _tmp_a[63] = ((va & 0x8000000000000000ull) == 0 ? (-1) : 1);
  _tmp_b[63] = ((vb & 0x8000000000000000ull) == 0 ? (-1) : 1);
...
inline float inner_product(const float *data, uint64_t va) {
  _tmp_a[0] = ((va & 0x1ull) == 0 ? 0 : 1);
  _tmp_a[1] = ((va & 0x2ull) == 0 ? 0 : 1);
  _tmp_a[2] = ((va & 0x4ull) == 0 ? 0 : 1);
  _tmp_a[3] = ((va & 0x8ull) == 0 ? 0 : 1);
  _tmp_a[4] = ((va & 0x10ull) == 0 ? 0 : 1);
  _tmp_a[5] = ((va & 0x20ull) == 0 ? 0 : 1);
  _tmp_a[6] = ((va & 0x40ull) == 0 ? 0 : 1);
  _tmp_a[7] = ((va & 0x80ull) == 0 ? 0 : 1);
  _tmp_a[8] = ((va & 0x100ull) == 0 ? 0 : 1);
  _tmp_a[9] = ((va & 0x200ull) == 0 ? 0 : 1);
  _tmp_a[10] = ((va & 0x400ull) == 0 ? 0 : 1);
  _tmp_a[11] = ((va & 0x800ull) == 0 ? 0 : 1);
  _tmp_a[12] = ((va & 0x1000ull) == 0 ? 0 : 1);
  _tmp_a[13] = ((va & 0x2000ull) == 0 ? 0 : 1);
  _tmp_a[14] = ((va & 0x4000ull) == 0 ? 0 : 1);
  _tmp_a[15] = ((va & 0x8000ull) == 0 ? 0 : 1);
  _tmp_a[16] = ((va & 0x10000ull) == 0 ? 0 : 1);
  _tmp_a[17] = ((va & 0x20000ull) == 0 ? 0 : 1);
  _tmp_a[18] = ((va & 0x40000ull) == 0 ? 0 : 1);
  _tmp_a[19] = ((va & 0x80000ull) == 0 ? 0 : 1);
  _tmp_a[20] = ((va & 0x100000ull) == 0 ? 0 : 1);
  _tmp_a[21] = ((va & 0x200000ull) == 0 ? 0 : 1);
  _tmp_a[22] = ((va & 0x400000ull) == 0 ? 0 : 1);
  _tmp_a[23] = ((va & 0x800000ull) == 0 ? 0 : 1);
  _tmp_a[24] = ((va & 0x1000000ull) == 0 ? 0 : 1);
  _tmp_a[25] = ((va & 0x2000000ull) == 0 ? 0 : 1);
  _tmp_a[26] = ((va & 0x4000000ull) == 0 ? 0 : 1);
  _tmp_a[27] = ((va & 0x8000000ull) == 0 ? 0 : 1);
  _tmp_a[28] = ((va & 0x10000000ull) == 0 ? 0 : 1);
  _tmp_a[29] = ((va & 0x20000000ull) == 0 ? 0 : 1);
  _tmp_a[30] = ((va & 0x40000000ull) == 0 ? 0 : 1);
  _tmp_a[31] = ((va & 0x80000000ull) == 0 ? 0 : 1);
  _tmp_a[32] = ((va & 0x100000000ull) == 0 ? 0 : 1);
  _tmp_a[33] = ((va & 0x200000000ull) == 0 ? 0 : 1);
  _tmp_a[34] = ((va & 0x400000000ull) == 0 ? 0 : 1);
  _tmp_a[35] = ((va & 0x800000000ull) == 0 ? 0 : 1);
  _tmp_a[36] = ((va & 0x1000000000ull) == 0 ? 0 : 1);
  _tmp_a[37] = ((va & 0x2000000000ull) == 0 ? 0 : 1);
  _tmp_a[38] = ((va & 0x4000000000ull) == 0 ? 0 : 1);
  _tmp_a[39] = ((va & 0x8000000000ull) == 0 ? 0 : 1);
  _tmp_a[40] = ((va & 0x10000000000ull) == 0 ? 0 : 1);
  _tmp_a[41] = ((va & 0x20000000000ull) == 0 ? 0 : 1);
  _tmp_a[42] = ((va & 0x40000000000ull) == 0 ? 0 : 1);
  _tmp_a[43] = ((va & 0x80000000000ull) == 0 ? 0 : 1);
  _tmp_a[44] = ((va & 0x100000000000ull) == 0 ? 0 : 1);
  _tmp_a[45] = ((va & 0x200000000000ull) == 0 ? 0 : 1);
  _tmp_a[46] = ((va & 0x400000000000ull) == 0 ? 0 : 1);
  _tmp_a[47] = ((va & 0x800000000000ull) == 0 ? 0 : 1);
  _tmp_a[48] = ((va & 0x1000000000000ull) == 0 ? 0 : 1);
  _tmp_a[49] = ((va & 0x2000000000000ull) == 0 ? 0 : 1);
  _tmp_a[50] = ((va & 0x4000000000000ull) == 0 ? 0 : 1);
  _tmp_a[51] = ((va & 0x8000000000000ull) == 0 ? 0 : 1);
  _tmp_a[52] = ((va & 0x10000000000000ull) == 0 ? 0 : 1);
  _tmp_a[53] = ((va & 0x20000000000000ull) == 0 ? 0 : 1);
  _tmp_a[54] = ((va & 0x40000000000000ull) == 0 ? 0 : 1);
  _tmp_a[55] = ((va & 0x80000000000000ull) == 0 ? 0 : 1);
  _tmp_a[56] = ((va & 0x100000000000000ull) == 0 ? 0 : 1);
  _tmp_a[57] = ((va & 0x200000000000000ull) == 0 ? 0 : 1);
  _tmp_a[58] = ((va & 0x400000000000000ull) == 0 ? 0 : 1);
  _tmp_a[59] = ((va & 0x800000000000000ull) == 0 ? 0 : 1);
  _tmp_a[60] = ((va & 0x1000000000000000ull) == 0 ? 0 : 1);
  _tmp_a[61] = ((va & 0x2000000000000000ull) == 0 ? 0 : 1);
  _tmp_a[62] = ((va & 0x4000000000000000ull) == 0 ? 0 : 1);
  _tmp_a[63] = ((va & 0x8000000000000000ull) == 0 ? 0 : 1);
...
inline int16_t fake_range_sum(uint64_t zero_one_vec, unsigned c_range) {
  ...
  int16_t r = ss::ann::helper::popcount(c & zero_one_vec) * 2;
  return (r - c_range);
}

inline int16_t fake_range_sum(uint64_t zero_one_vec) {
  int16_t r = ss::ann::helper::popcount(zero_one_vec) * 2;
  return (r - 64);
}
